...
public static class ErrorMessages
{
    ...
    public const string UNABLE_UPDATE_ROLE_MENU = "Unable to update the Role menus";
    ...
    public const string TOKEN_INVALID_OR_EXPIRED = "Invalid or expired refresh token";
